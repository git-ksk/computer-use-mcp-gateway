...
> **Runtime status:** V2 Hub + Agent is the recommended development/runtime path. `v0.6.0` Managed Developer Execution is the current released baseline. V1 remains available as `v1_gateway` for regression/reference and existing production operation.
