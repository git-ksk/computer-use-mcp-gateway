...
> Status: **V1 hardened / pre-alpha; automated closeout complete**. The gateway connects to Cua over MCP stdio, applies a fail-closed capability boundary, and keeps the network listener on localhost by default. Two operator-controlled acceptance checks remain before V1 is formally closed; see [`docs/V1_ACCEPTANCE.md`](docs/V1_ACCEPTANCE.md).
