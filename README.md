...
> **Runtime status:** V2 Hub + Agent is the recommended development/runtime path. `v0.5.0` Least-privilege Workspace is the current released baseline. V1 remains available as `v1_gateway` for regression/reference and existing production operation.
