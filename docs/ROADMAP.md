...
1. **Completed operator foundations:** #226 lane-scoped readiness, #233 operator-ready incident brief, and #234 durable/inspectable single-Mac upgrade transactions are complete and provide the inputs for #235.
