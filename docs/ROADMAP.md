...
| Other compatible stabilization | #215, #104, #111, bounded #96 work | #104 implementation complete in this change; others parallel/deferred | Non-blocking unless new evidence exposes a released regression |
...
- **`0.3.x` — Product Readiness & Stabilization:** #237 and the #213 cross-cutting closeout are complete; future releases reuse the standing [`PRODUCT_READINESS.md`](PRODUCT_READINESS.md) gate. The #226/#233/#234/#235/#109/#236 operator/recovery foundation and #224 release-candidate artifact boundary are complete. #115 actionable indeterminate UX is complete. Compatible non-blocking stabilization may continue through #215, #111, and the bounded investigation/documentation part of #96; #104 least-privilege filesystem-root separation is implementation-complete in this change without making the milestone an unbounded backlog-clearing exercise.
