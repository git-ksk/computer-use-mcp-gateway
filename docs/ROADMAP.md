...
- **`v0.9.0 — Hosted Hub & Handoff`:** #215 Cloud Run support gate, #275 Agent-owned Handoff topology, #276 reviewed Handoff consumer adoption, #277 hosted operator routing, #282 closed one-port ingress, #283 durable Hub state/writer-epoch fencing, #391 async PostgreSQL hosted Hub-state backend, #353 hosted secret/key rotation acceptance, and #284 final replacement/partition/physical-Handoff acceptance.
