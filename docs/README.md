...
- [`PRODUCT_READINESS.md`](PRODUCT_READINESS.md) — standing cross-cutting release-readiness checklist for distribution, operations, compatibility, and safety.
...
- [`v2/V2_BACKUP_RESTORE.md`](v2/V2_BACKUP_RESTORE.md) — coherent single-Mac backup/restore boundary that preserves paired runtime identity and quarantine truth.
