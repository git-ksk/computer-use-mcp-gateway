...
#213 close はすべてのfuture-platform / hosted-deployment issue完了を意味しません。#104/#111/#115 と bounded #96 investigation は完了済みです。#215 Cloud Run designも完了していますが、hosted supportはfuture NO-GO implementation/acceptance trackのままです。active `0.4.0` candidateはRecovery & Reconciliation、multi-principal identity、semantic authorizationを統合し、#217/#228と#139のsupport claimにはroadmap記載のexplicit acceptance boundaryを維持します。#227 physical Windows Hello acceptanceは2026-09-19にPASS済みです。
