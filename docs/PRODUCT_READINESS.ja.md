...
#213 close はすべての future-platform / hosted-deployment issue 完了を意味しません。#104/#111/#115 と bounded #96 investigation は完了済みです。#215 Cloud Run design も完了していますが、hosted support は future NO-GO implementation/acceptance track のままです。released `0.4.0` baseline は Recovery & Reconciliation、multi-principal identity plumbing、semantic authorization を統合し、#217/#228 と #139 の support claim には roadmap 記載の explicit acceptance boundary を維持します。#227 physical Windows Hello acceptance は 2026-09-19 に PASS 済みです。
