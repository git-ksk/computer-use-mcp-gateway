...
12. Control schema version 7 and capability-advertisement schema version 4 are both exact fail-closed boundaries; incompatible peers are rejected rather than mixed.
