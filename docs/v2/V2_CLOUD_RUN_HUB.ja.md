...
Status: Issue #215 の **design complete / #282 ingress merge済み / #283 durable-state・writer-fence coreはPR #388でmerge済み / hosted provider・deployment/physical acceptance pending**。
