...
Closing #213 does not mean every future-platform or hosted-deployment issue is complete. #104/#111/#115 and the bounded #96 investigation are complete. #215 Cloud Run design is complete but hosted support remains a future NO-GO implementation/acceptance track. The released `0.4.0` baseline integrates Recovery & Reconciliation with multi-principal identity plumbing and semantic authorization; #217/#228 and #139 retain explicit support-claim acceptance boundaries as documented in the roadmap, while #227 physical Windows Hello acceptance passed on 2026-09-19.
